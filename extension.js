...
var VitalsMenuButton = GObject.registerClass(
  ...
  class VitalsMenuButton extends PanelMenu.Button {
    ...
    _initializeTimer() {
      ...
      this._refreshTimeoutId = GLib.timeout_add_seconds(
        ...
        (self) => {
          ...
          if (Object.values(this._hotLabels).length > 0) this._querySensors();
    ...
    _removeHotLabels() {
      for (let key in this._hotLabels) this._removeHotLabel(key);
    }
    ...
    _removeHotIcons() {
      for (let key in this._hotIcons) this._removeHotIcon(key);
    }
