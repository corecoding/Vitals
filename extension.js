...
var VitalsMenuButton = GObject.registerClass({
    ...
    _init() {
        ...
        let settings = [ 'use-higher-precision', 'alphabetize', 'hide-zeros', 'fixed-widths', 'hide-icons', 'query-nvidia-smi', 'unit', 'memory-measurement', 'include-public-ip', 'network-speed-format', 'storage-measurement', 'include-static-info' ];
