...
var VitalsMenuButton = GObject.registerClass({
    ...
    _init(extensionObject) {
        ...
        this._addSettingChangedSignal('menu-centred', this._positionInPanelChanged.bind(this));
    ...
    _positionInPanel() {
        ...
        let centred = this._settings.get_boolean('menu-centred')
        
        if (centred) arrow_pos = 0.5;
